...
class BodyPart {
  ...
  static const List<BodyPart> all = [
    ...
    BodyPart(key: 'bicep_left', label: 'Left bicep',
        ...
        male: (0.35, 0.300), female: (0.33, 0.305), min: 20, max: 52, initial: 32),
    BodyPart(key: 'bicep_right', label: 'Right bicep',
        ...
        male: (0.81, 0.300), female: (0.67, 0.305), min: 20, max: 52, initial: 32),
    BodyPart(key: 'forearm_left', label: 'Left forearm',
        ...
        male: (0.29, 0.430), female: (0.28, 0.435), min: 18, max: 40, initial: 27),
    BodyPart(key: 'forearm_right', label: 'Right forearm',
        ...
        male: (0.83, 0.430), female: (0.72, 0.435), min: 18, max: 40, initial: 27),
