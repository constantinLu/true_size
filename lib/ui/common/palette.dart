...
class Palette {
  static const List<Color> gradients = [greySpanish, greyDim, blackJet];

  static primaryColor(context) => Theme.of(context).primaryColor;
  //static backgroundColor(context) => Theme.of(context).colorScheme.surface;
  ...
  static const disabledBackgroundColor = Color.fromRGBO(75, 85, 99, 1);
  static const buttonColor = Color.fromRGBO(44, 44, 46, 1);
